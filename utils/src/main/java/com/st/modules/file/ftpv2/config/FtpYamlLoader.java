package com.st.modules.file.ftpv2.config;
...
public class FtpYamlLoader {
    public static Map<String, FtpClientConfig> loadFromClasspath(String fileName) throws IOException {
        ...
        Map<String, Object> ftp = (Map<String, Object>) root.get("ftp");
        Map<String, Object> clients = (Map<String, Object>) ftp.get("clients");
        ...
        for (Map.Entry<String, Object> entry : clients.entrySet()) {
            ...
            cfg.setProtocol((String) raw.get("protocol"));
            cfg.setHost((String) raw.get("host"));
            cfg.setPort((Integer) raw.get("port"));
            cfg.setUsername((String) raw.get("username"));
            cfg.setPassword((String) raw.get("password"));

            Map<String, String> paths = new HashMap<>();
            Object pathObj = raw.get("paths");

...
import com.st.modules.file.ftp.client.ftp.deprecared.FtpClientExitUtils;
import org.apache.commons.net.ftp.FTPClient;
import org.apache.commons.net.ftp.FTPFile;

import java.io.IOException;
public class FtpExistHelper {
         ...
         */
        public static boolean fileExists(FTPClient ftpClient, String remotePath) throws IOException {
//            FTPClient ftpClient = FTPClientFactory.getFtpClient();
     ...
     * @return true 表示目录存在
     */
    public static boolean directoryExists(FTPClient ftpClient, String remoteDir) throws IOException {
//        FTPClient ftpClient = FTPClientFactory.getFtpClient();

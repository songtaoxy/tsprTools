...
import com.st.optional.guava.jdk6.common.annotations.Nullable;
import com.st.optional.guava.jdk6.common.errorprone.annotations.CanIgnoreReturnValue;
import com.st.optional.guava.jdk6.common.errorprone.annotations.concurrent.LazyInit;


import java.io.Serializable;
import java.util.Iterator;

import static com.st.optional.guava.jdk6.common.base.Preconditions.*;
...
public abstract class Converter<A, B> implements com.google.common.base.Function<A, B> {
  ...
  public static <A, B> Converter<A, B> from(
      com.st.optional.guava.jdk6.common.base.Function<? super A, ? extends B> forwardFunction,
      com.st.optional.guava.jdk6.common.base.Function<? super B, ? extends A> backwardFunction) {
  ...
  private static final class FunctionBasedConverter<A, B> extends Converter<A, B>
      implements Serializable {
    private final com.st.optional.guava.jdk6.common.base.Function<? super A, ? extends B> forwardFunction;
    private final com.st.optional.guava.jdk6.common.base.Function<? super B, ? extends A> backwardFunction;

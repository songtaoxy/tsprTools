...
final class Platform {
  ...
  static <T extends Enum<T>> com.st.optional.guava.jdk6.common.base.Optional<T> getEnumIfPresent(Class<T> enumClass, String value) {
    WeakReference<? extends Enum<?>> ref = Enums.getEnumConstants(enumClass).get(value);
    return ref == null
        ? com.st.optional.guava.jdk6.common.base.Optional.<T>absent()

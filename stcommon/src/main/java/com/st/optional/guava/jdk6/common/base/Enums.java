...
import com.st.optional.guava.jdk6.common.annotations.GwtIncompatible;
...
public final class Enums {
  ...
  public static <T extends Enum<T>> Optional<T> getIfPresent(Class<T> enumClass, String value) {
    ...
    checkNotNull(value);
    return com.st.optional.guava.jdk6.common.base.Platform.getEnumIfPresent(enumClass, value);
  }

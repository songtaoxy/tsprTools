package com.st.modules.common.xml;
...
public class ReadXML {
	...
	public void xml() {
		...
		try {
			document = reader.read(new File("/Users/songtao/personaldriveMac/Projects/tsprTools/stcommon/src/main/java/com/st/modules/common/xml/data_test.xml"));

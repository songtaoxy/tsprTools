...
import com.st.modules.jdk6.goole.guava.v20_0.common.annotations.VisibleForTesting;
...
public final class Suppliers {
  ...
  private static class SupplierComposition<F, T> implements com.google.common.base.Supplier<T>, Serializable {
  ...
  @VisibleForTesting
  static class MemoizingSupplier<T> implements com.google.common.base.Supplier<T>, Serializable {
   ...
   * @since 2.0
   */
  public static <T> com.google.common.base.Supplier<T> memoizeWithExpiration(
          com.google.common.base.Supplier<T> delegate, long duration, TimeUnit unit) {
    return new ExpiringMemoizingSupplier<T>(delegate, duration, unit);
  }

  @VisibleForTesting
  static class ExpiringMemoizingSupplier<T> implements com.google.common.base.Supplier<T>, Serializable {
    final com.google.common.base.Supplier<T> delegate;
    ...
    ExpiringMemoizingSupplier(com.google.common.base.Supplier<T> delegate, long duration, TimeUnit unit) {
   ...
   */
  public static <T> com.google.common.base.Supplier<T> ofInstance(@Nullable T instance) {
    return new SupplierOfInstance<T>(instance);
  }

  private static class SupplierOfInstance<T> implements com.google.common.base.Supplier<T>, Serializable {
    final T instance;
  ...
  private static class ThreadSafeSupplier<T> implements com.google.common.base.Supplier<T>, Serializable {
    final com.google.common.base.Supplier<T> delegate;
   ...
   * com.google.common.base.Supplier#get} on that supplier.
   *
  ...
  private interface SupplierFunction<T> extends Function<com.google.common.base.Supplier<T>, T> {}

...
package com.st.modules.jdk6.goole.guava.v20_0.common.base;
...
public final class Functions {
   ...
   * future, when this class requires Java 8, this method will be deprecated. See {@link com.google.common.base.Function}
   * for more important information about the Java 8 transition.
   */
  public static com.google.common.base.Function<Object, String> toStringFunction() {
  ...
  public static <E> com.google.common.base.Function<E, E> identity() {
    return (com.google.common.base.Function<E, E>) IdentityFunction.INSTANCE;
  }

  // enum singleton pattern
  private enum IdentityFunction implements com.google.common.base.Function<Object, Object> {
    INSTANCE;
   ...
   * instead.
   */
  public static <K, V> com.google.common.base.Function<K, V> forMap(Map<K, V> map) {
    return new FunctionForMapNoDefault<K, V>(map);
  }

  private static class FunctionForMapNoDefault<K, V> implements com.google.common.base.Function<K, V>, Serializable {
    final Map<K, V> map;
   ...
   */
  public static <K, V> com.google.common.base.Function<K, V> forMap(Map<K, ? extends V> map, @Nullable V defaultValue) {
    return new ForMapWithDefault<K, V>(map, defaultValue);
  }

  private static class ForMapWithDefault<K, V> implements com.google.common.base.Function<K, V>, Serializable {
  ...
  private static class FunctionComposition<A, B, C> implements com.google.common.base.Function<A, C>, Serializable {
   ...
   * {@link com.google.common.base.Function#apply}) if and only if {@code predicate} is itself consistent with equals.
   *
   * <p><b>Java 8 users:</b> use the method reference {@code predicate::test} instead.
   */
  public static <T> com.google.common.base.Function<T, Boolean> forPredicate(Predicate<T> predicate) {
    return new PredicateFunction<T>(predicate);
  }

  /** @see Functions#forPredicate */
  private static class PredicateFunction<T> implements com.google.common.base.Function<T, Boolean>, Serializable {
   ...
   */
  public static <E> com.google.common.base.Function<Object, E> constant(@Nullable E value) {
    return new ConstantFunction<E>(value);
  }

  private static class ConstantFunction<E> implements com.google.common.base.Function<Object, E>, Serializable {
   ...
   * @since 10.0
   */
  public static <T> com.google.common.base.Function<Object, T> forSupplier(com.google.common.base.Supplier<T> supplier) {

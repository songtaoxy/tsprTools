...
package com.st.modules.jdk6.goole.guava.v20_0.common.collect;

import com.st.modules.jdk6.goole.guava.common.annotations.*;
import com.st.modules.jdk6.goole.guava.v20_0.common.annotations.Beta;
import com.st.modules.jdk6.goole.guava.v20_0.common.annotations.CanIgnoreReturnValue;
import com.st.modules.jdk6.goole.guava.v20_0.common.annotations.GwtCompatible;
import com.st.modules.jdk6.goole.guava.v20_0.common.annotations.GwtIncompatible;
import com.st.modules.jdk6.goole.guava.v20_0.common.base.Function;
import com.st.modules.jdk6.goole.guava.v20_0.common.base.Preconditions;
import com.st.modules.jdk6.goole.jsr305.v3_0_2.javax.annotation.Nullable;
import com.st.optional.guava.jdk6.common.annotations.*;
...
public final class Iterators {
  ...
  public static <T> com.google.common.collect.UnmodifiableIterator<T> unmodifiableIterator(
      final Iterator<? extends T> iterator) {
    checkNotNull(iterator);
    if (iterator instanceof com.google.common.collect.UnmodifiableIterator) {
      @SuppressWarnings("unchecked") // Since it's unmodifiable, the covariant cast is safe
      com.google.common.collect.UnmodifiableIterator<T> result = (com.google.common.collect.UnmodifiableIterator<T>) iterator;
      return result;
    }
    return new com.google.common.collect.UnmodifiableIterator<T>() {
      @Override
      public boolean hasNext() {
   ...
   */
  public static <T> com.google.common.collect.UnmodifiableIterator<List<T>> partition(Iterator<T> iterator, int size) {
   ...
   * @throws IllegalArgumentException if {@code size} is nonpositive
   */
  public static <T> com.google.common.collect.UnmodifiableIterator<List<T>> paddedPartition(Iterator<T> iterator, int size) {
    return partitionImpl(iterator, size, true);
  }

  private static <T> com.google.common.collect.UnmodifiableIterator<List<T>> partitionImpl(
      final Iterator<T> iterator, final int size, final boolean pad) {
    checkNotNull(iterator);
    checkArgument(size > 0);
    return new com.google.common.collect.UnmodifiableIterator<List<T>>() {
      @Override
      public boolean hasNext() {
        return iterator.hasNext();
      }
   ...
   */
  public static <T> com.google.common.collect.UnmodifiableIterator<T> filter(
  ...
  public static <T> com.google.common.collect.UnmodifiableIterator<T> filter(Iterator<?> unfiltered, Class<T> desiredType) {
    return (com.google.common.collect.UnmodifiableIterator<T>) filter(unfiltered, instanceOf(desiredType));
  }
  ...
  public static <T> Optional<T> tryFind(Iterator<T> iterator, Predicate<? super T> predicate) {
    com.google.common.collect.UnmodifiableIterator<T> filteredIterator = filter(iterator, predicate);
   ...
   * Arrays#asList(Object[])}, {@link com.google.common.collect.ImmutableList#copyOf(Object[])}},
   * or {@link ImmutableList#of}.
   */
  @SafeVarargs
  public static <T> com.google.common.collect.UnmodifiableIterator<T> forArray(final T... array) {
   ...
   */
  public static <T> com.google.common.collect.UnmodifiableIterator<T> singletonIterator(@Nullable final T value) {
    return new com.google.common.collect.UnmodifiableIterator<T>() {
      boolean done;
   ...
   * Collections#list}.
   */
  public static <T> com.google.common.collect.UnmodifiableIterator<T> forEnumeration(final Enumeration<T> enumeration) {
   ...
   */
  public static <T> com.google.common.collect.PeekingIterator<T> peekingIterator(Iterator<? extends T> iterator) {
   ...
   */
  @Beta
  public static <T> com.google.common.collect.UnmodifiableIterator<T> mergeSorted(
  ...
  private static class MergingIterator<T> extends UnmodifiableIterator<T> {
    final Queue<com.google.common.collect.PeekingIterator<T>> queue;
    ...
    public MergingIterator(
      ...
      Comparator<com.google.common.collect.PeekingIterator<T>> heapComparator =
          new Comparator<com.google.common.collect.PeekingIterator<T>>() {
            @Override
            public int compare(com.google.common.collect.PeekingIterator<T> o1, com.google.common.collect.PeekingIterator<T> o2) {
              return itemComparator.compare(o1.peek(), o2.peek());
            }
          };

      queue = new PriorityQueue<com.google.common.collect.PeekingIterator<T>>(2, heapComparator);

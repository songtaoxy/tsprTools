...
public class ReadXML {
	...
	public void xml() {
		...
		try {
			document = reader.read(new File("/Users/songtao/personaldriveMac/Projects/tsprTools/stbptools008/src/main/java/com/st/modules/xml/data_test.xml"));

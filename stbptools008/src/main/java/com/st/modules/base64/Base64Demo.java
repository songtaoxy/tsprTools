...
public class Base64Demo {
  public static void main(String[] args) throws UnsupportedEncodingException {
    ...
    String strEncoded = "NGNlNTc3NTE4OTUyMmMzNmMxYjcxZDZmMmEyOGFkNmU=";
     ...
     */
    String strDec = new String(Base64.getDecoder().decode(strEncoded), "utf-8");

    System.out.println(strDec);
    System.out.println(strDec.equals(str));

    String strOriginal = "NGNlNTc3NTE4OTUyMmMzNmMxYjcxZDZmMmEyOGFkNmU=";
    String DEFAULT_KEY = new String(Base64.getDecoder().decode(strOriginal), "utf-8");
    System.out.println(DEFAULT_KEY);
    System.out.println(DEFAULT_KEY.equals(str));
  }
}
